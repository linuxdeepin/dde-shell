...
QString DbusAdaptor::GetServerInformation(QString &name, QString &vendor, QString &specVersion)
{
    auto manager = qobject_cast<NotificationManager *>(parent());
    if (!manager)
        return QString();

    return manager->GetServerInformation(name, vendor, specVersion);
}

DDENotificationDbusAdaptor::DDENotificationDbusAdaptor(QObject *parent) : DbusAdaptor(parent)
{
    setAutoRelaySignals(true);
}
...
void DDENotificationDbusAdaptor::Toggle()
{

}

void DDENotificationDbusAdaptor::Show()
{

}

void DDENotificationDbusAdaptor::Hide()
{
