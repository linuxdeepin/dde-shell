...
{
    xcb_connection_t *conn = qGuiApp->nativeInterface<QNativeInterface::QX11Application>()->connection();
...
bool ScreenSpliter_Xcb::split(ScreenSpliter::SplitDirection direction)
{
    ...
    auto xconn = qGuiApp->nativeInterface<QNativeInterface::QX11Application>()->connection();
    xcb_send_event(xconn, false, /*QX11Info::appRootWindow(QX11Info::appScreen())*/0,
